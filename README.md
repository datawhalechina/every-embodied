...
| **第三阶段** | 模仿学习、大模型(VLA/VLN)、Sim2Real | 复现大模型导航VLN、OpenVLA、SmolVLA 等前沿项目，实现仿真或真实部署 |
  ...
  ## 🔥 News & Highlights
  - **[2026-08-08]** 新增 [RDK Challenge 参赛分享：TuntunClaw 家庭物资助手](./15-Challenge竞赛/RDK-Challenge/README.md)：记录 Every Embodied 社区成员基于 RDK X5 Magic Box 完成的具身智能项目，从 MuJoCo 仿真、OpenClaw 任务调度、VLM + SAM 目标理解与 GraspNet 抓取推理，延伸到真实机械臂取放、库存更新、平板反馈和低库存语音提醒，并整理官方赛事海报、完整演示视频与开源项目入口。
